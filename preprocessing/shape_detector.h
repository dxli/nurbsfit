...
public:
    ...
    void save_primitive_conection(const std::string & filename);
	void save_metrics(const std::string & filename);
...
public:
	...
	void to_vg(std::string & out_dir);
	void save_alpha_shapes(std::string & out_dir);
	void save_convex_hull(std::string & out_dir);
